...
def BaseProviderParser():
    """ArgParse instance that could be used as a base by any Provider for its argument parsing"""
...
def MainParser():
    """ArgParse instance exposed as the main parser for Lexicon CLI"""
    providers = []
