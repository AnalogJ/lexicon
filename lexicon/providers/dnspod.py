...
def ProviderParser(subparser):
    subparser.add_argument("--auth-id", help="specify token id used authenticate to DNS provider. It's NOT your account username.")
...
class Provider(BaseProvider):
    ...
    def _request(self, action='GET',  url='/', data=None, query_params=None):
        if data is None:
            data = {}
        data['login_token'] = self.options['auth_id'] + ',' + self.options['auth_token']
        data['format'] = 'json'
