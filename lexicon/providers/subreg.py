...
from lexicon.providers.gransy import Provider as GransyProvider
from lexicon.providers.gransy import gransy_provider_parser
...
def provider_parser(subparser):
    ...
    subparser.description = (
        "Compatibility proxy for Gransy site subreg.cz. The Subreg "
