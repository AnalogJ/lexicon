...
class Provider(BaseProvider):
    ...
    def _convert_to_henet(self, record):
        """ converts from lexicon format record to henet format record,
        """
        name = record['name']
        if name.endswith('.'):
            name = name[:-1]
    ...
    def _convert_to_lexicon_from_zone_img(self, zone_img):
        """ converts a zone_img object into a lexicon object
        """
